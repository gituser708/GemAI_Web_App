...
import { handleFreeSubscriptionAPI } from '../../API/payment/paymentAPI'
...
const FreePlanSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        {mutation.isPending && (
          <StatusMessage type='loading' message='Hold on, While Loading...' />
        )}
        ...
        <ul className="list-disc list-inside mb-6 text-gray-600 font-semibold">
